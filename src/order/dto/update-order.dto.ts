...
export class UpdateOrderItemDto {
  ...
  @ApiProperty({
    description: "The ID of the order this item belongs to (set by the server)",
    example: 1,
    required: false,
  })
  @IsOptional()
...
export class CreateOrderDto {
  ...
  @IsOptional()
  @IsISO8601({}, { message: "Approve date must be a valid ISO 8601 date" })
  approveDate?: string;
  ...
  @IsOptional()
  @IsISO8601({}, { message: "Shipped date must be a valid ISO 8601 date" })
  shippedDate?: string;
  ...
  @IsOptional()
  @IsISO8601({}, { message: "Cancelled date must be a valid ISO 8601 date" })
  ...
  @IsOptional()
  @IsISO8601({}, { message: "Completed date must be a valid ISO 8601 date" })
  ...
  @IsOptional()
  @IsISO8601({}, { message: "Return date must be a valid ISO 8601 date" })
  returnDate?: string;
  ...
  @IsOptional()
  @IsISO8601({}, { message: "Print datetime must be a valid ISO 8601 date" })
